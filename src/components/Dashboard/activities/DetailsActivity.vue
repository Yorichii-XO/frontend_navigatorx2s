        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white shadow-xl rounded-2xl">
                    <div class="p-6 pb-0 mb-0 flex w-full ">
                        <h6 class="font-semibold text-lg"> Activity Details for {{ activity ? activity.name : "N/A" }}
                        </h6>
                        <router-link to="/activities">
                            <button 
                                class="text-white button-back bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-full">Back
                                to Activities &nbsp;<i class="fas fa-arrow-left"></i></button>
                        </router-link>
                    </div>
                                ...
                                <tbody>
                                    <tr v-if="activity">
                                        ...
                                        <td
                                            class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <div
                                                class="w-8 h-8 flex items-center justify-center bg-blue-500 text-white rounded-full">
                                    ...
                                    <tr v-else>
                                        <td colspan="7" class="text-center text-red-500">No activity data available.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
